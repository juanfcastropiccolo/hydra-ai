...
| 2026-08-23 | Los nombres de sesión editados son un alias guardado por Hydra (`ui.sessionNames`), no un rename en el CLI | El CLI no expone rename para sesiones background; el alias se aplica al mostrar y no altera al daemon. | 001 |
| 2026-08-23 | AC-2b: primera sesión < 10 s (daemon frío), siguientes < 5 s | Medido 8,8 s / 2,3–2,9 s en QA. | 001 |
