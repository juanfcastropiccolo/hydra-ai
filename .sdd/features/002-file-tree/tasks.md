...
Feature ID: 002
Status: complete (2026-08-23) — pendiente menor: ⌘⇧E en la .app empaquetada
...
- [x] **17.** (QA de Juan ✅ 2026-08-23; pendiente conocido: ⌘⇧E en .app) QA manual `docs/qa-002.md` (AC-6/7/8, ⌘⇧E con foco en xterm, repo grande real con `node_modules`, Revelar en Finder, VS Code) + empaquetar `Hydra.app` 0.2.0 — done when: checklist completo por Juan; fallos → tasks de fix.
- [x] **18.** Cierre: README (sección "Árbol de archivos"), CLAUDE.md (módulos nuevos y reglas: un watcher por root, git CLI), `status.json` → `complete`, `.sdd/README.md`, tag `v0.2.0` — done when: hecho y pusheado.
