...
10. **FR-10 — Queda pegado, no enviado:** el resultado se escribe en el **prompt del pane destino** como si el usuario lo hubiera pegado: un único bloque multilínea, **sin pulsar Enter**, y **visible completo** (no colapsado como "[Pasted text…]") para poder revisarlo — ajuste pedido por Juan en QA 2026-08-23. El usuario lo revisa, lo edita o lo borra con las teclas habituales del prompt de Claude Code, y lo envía cuando quiere. El pane destino recibe el foco al terminar el pegado.
