...
- [001 — Workspace de sesiones de Claude Code](features/001-session-workspace/) — specified (20%)

## Backlog (aún sin spec, en orden tentativo)

- 002 — Árbol de archivos del proyecto (file tree tipo editor, junto a la grilla).
- 003 — Chat box por pane (input debajo de cada terminal que escribe a esa sesión).
